...
activar_ssl_python() {
    ...
    DEBIAN_FRONTEND=noninteractive apt-get install -y build-essential zlib1g-dev wget bzip2 libcrypt-dev libpam0g-dev >> /var/log/MaximusVpsMx/dropbear_compile.log 2>&1
...
PAMEOF
                ...
                echo -e "${GREEN}  ✓ Dropbear compilado con soporte legacy y PAM exitosamente.${NC}"
            else
    ...
    def run(self):
        ...
        try:
            ...
            if is_payload:
                ...
                # Si STATUS_CODE es 101 o la petición trae payload, SIEMPRE enviar 101 WebSocket (Comportamiento ChumoGH)
