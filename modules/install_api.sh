...
echo -e "\e[1;32m[+] Configurando la API de WhatsApp para MaximusVpsMx...\e[0m"

# Dar permisos de ejecucion
chmod +x /etc/MaximusVpsMx/core/api_whatsapp.py
...
Type=simple
User=root
ExecStart=/usr/bin/python3 /etc/MaximusVpsMx/core/api_whatsapp.py
Restart=always
RestartSec=3
...
echo -e "\e[1;36m=========================================================\e[0m"
echo -e "\e[1;32m   [✅] API INSTALADA Y CORRIENDO EN EL PUERTO 8085    \e[0m"
echo -e "\e[1;36m=========================================================\e[0m"
