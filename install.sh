...
if [ ! -f /etc/MaximusVpsMx/core/small_banner.txt ]; then
    echo "[MAXIMUS C J&J] Si te revendieron este servidor TE ESTAFARON - Grupo: https://chat.whatsapp.com/Gmti2GoprFa0Uf4tuGD4dP?s=cl&p=a&ilr=0" > /etc/MaximusVpsMx/core/small_banner.txt
fi
